...
The final storage target is still pending team confirmation. The planned direction is GCP Cloud Storage, but `storage_client.py` remains provider-abstract and does not implement real signed URLs.
